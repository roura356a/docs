...
[![Build Status](https://doi-janky.infosiftr.net/job/multiarch/job/amd64/job/arangodb/badge/icon) (`amd64/arangodb` build job)](https://doi-janky.infosiftr.net/job/multiarch/job/amd64/job/arangodb/)
